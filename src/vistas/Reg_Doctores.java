 ...
 * @author Nadia
 */
public class Reg_Doctores extends javax.swing.JFrame {

    /**
     * Creates new form Reg_Doctores
     */
    public Reg_Doctores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(1080, 74));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reg_Doctores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reg_Doctores().setVisible(true);
            }
        });
    }
